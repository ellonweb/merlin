...
urlpatterns = patterns('Arthur.views.alliance',
    ...
    url(r'^alliances/intel/$', 'ialliances.ialliances'),
    url(r'^alliances/intel/(?P<page>\d+)/$', 'ialliances.ialliances'),
    url(r'^alliances/intel/(?P<sort>\w+)/$', 'ialliances.ialliances'),
    url(r'^alliances/intel/(?P<sort>\w+)/(?P<page>\d+)/$', 'ialliances.ialliances', name="ialliances"),
)
