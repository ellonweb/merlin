...
urlpatterns = patterns('Arthur.rankings',
    ...
    url(r'^alliance/(?P<name>[\w ]+)/$', 'alliance.alliance', name="alliance_members"),
    url(r'^alliance/(?P<name>[\w ]+)/history/$', 'ialliancehistory.ialliancehistory', name="alliance_history"),
