...
if round:
    ...
    session.execute(text("INSERT INTO users (id, name, alias, passwd, active, access, email, phone, pubphone, googlevoice, sponsor, quits, available_cookies, carebears, last_cookie_date) SELECT id, name, alias, passwd, active, access, email, phone, pubphone, googlevoice, sponsor, quits, available_cookies, carebears, last_cookie_date FROM %s.users;" % (round,)))
